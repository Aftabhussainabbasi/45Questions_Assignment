...
console.log("\n Exercise 2: Personal Message.");
let personName = "JohnWick";
console.log(`Hello ${personName}, would you like to learn some Python today?`);
// Exercise 3: Name Cases
console.log("\n Exercise 3: Name Cases ");
//Lower case:
let personName1 = "John Wick";
...
let stripping = personName2.trim();
...
// Exercise 11: Names
console.log("\n Exercise 11: Names");
let members = ["Aftab", "Jhon", "Adnan", "Bilal"];
for (let i = 0; i < members.length; i++) {
    console.log(members[i]);
}
// Exercise 12: Greetings
console.log("\n Exercise 12: Greetings");
let members1 = ["Aftab", "Jhon", "Adnan", "Bilal"];
let message1 = "we are doing 1st Assignment of AI course: ";
for (let i = 0; i < members1.length; i++) {
    console.log(message1 + members1[i]);
}
// Exercise 13: Your Own Array
console.log("\n Exercise 13: Your Own Array");
let transportation = ["Car", "Bus", "Train", "Bike", "JF 17 Thunder"];
...
let not_present1 = "Hanan";
let new_guest1 = "Imran ";
...
let not_present2 = "Hanan";
let new_guest2 = "Imran ";
...
console.log("\n Exercise 17: Shrinking Guest List");
let guestList3 = ["Governor Sir: Kamran Tessori", "Adnan", "M.Umar", "Bilal", "Hanan"];
let not_present = "Hanan";
let new_guest = "Imran";
...
console.log("\n Exercise 18: Seeing the World");
let placesToVisit = ["Saudia Arab", "Qatar", "Japan", "Russia", "Indonesia"];
...
let cities = ["Karachi", "Islamabad", "Hyderabad"];
console.log("Cities:", cities);
let rivers = ["River Indus", "Chenab", "Ravi"];
console.log("Rivers:", rivers);
// Exercise 21: TypeScript Object
console.log("\n Exercise 21: TypeScript Object");
let city = { name: "Karachi", country: "Pakistan" };
console.log("City:", city);
// Exercise 22: Intentional Error
console.log("Exercise 22: Intentional Error");
const languages = ["C++", "Java", "TypeScript"];
...
let alien_color1 = 'red'; // Set alien_color to 'red' to run the else block
if (alien_color1 === 'red') {
...
console.log('\n Exercise 30: Hello Admin');
const usernames = ['admin', 'Eric', 'Aftab', 'Adnan', 'Usama'];
...
console.log('\n Exercise 31: No Users');
let users = ['Aftab', 'Usama', 'Jhon wick'];
if (users.length === 0) {
...
console.log('\n Exercise 32: Checking Usernames');
const current_users = ['Aftab', 'Usama', 'Admin', 'Jhon wick', 'Guest'];
const new_users = ['Adnan', 'Saleem', 'Admin', 'Jhon wick', 'Mary jane'];
...
// Exercise 34: Pizzas
console.log("\n Exercise 34: Pizzas");
let favoritePizzas = ["Pepperoni", "Margherita", "Chicken Fajita"];
...
const magicians = ["David Copperfield", "David Blaine", "Harry Houdini"];
const great_magicians = make_great(magicians);
show_magicians(great_magicians);

// Exercise 43: Unchanged Magicians
console.log("\n Exercise 43: Unchanged Magicians");
const original_magicians = ["David Copperfield", "David Blaine", "Harry Houdini"];
const modified_magicians = make_great(original_magicians.slice());
